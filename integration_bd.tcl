...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set USB_PULLUP [ create_bd_port -dir O USB_PULLUP ]

  # Create instance: EdXel_v1_0, and set properties
  set EdXel_v1_0 [ create_bd_cell -type ip -vlnv SDB:user:EdXel_v1:1.2 EdXel_v1_0 ]
  set_property -dict [ list CONFIG.NUM_EPU {1}  ] $EdXel_v1_0
  ...
  connect_bd_intf_net -intf_net processing_system7_1_axi_periph_M03_AXI [get_bd_intf_pins EdXel_v1_0/s00_axi] [get_bd_intf_pins processing_system7_1_axi_periph/M03_AXI]
connect_bd_intf_net -intf_net processing_system7_1_axi_periph_M03_AXI [get_bd_intf_pins ila_1/SLOT_0_AXI] [get_bd_intf_pins processing_system7_1_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net sws_8bits_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins sws_8bits/GPIO]

  # Create port connections
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins EdXel_v1_0/s00_axi_aclk] [get_bd_pins btns_5bits/s_axi_aclk] [get_bd_pins ila_1/clk] [get_bd_pins leds_8bits/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1_axi_periph/ACLK] [get_bd_pins processing_system7_1_axi_periph/M00_ACLK] [get_bd_pins processing_system7_1_axi_periph/M01_ACLK] [get_bd_pins processing_system7_1_axi_periph/M02_ACLK] [get_bd_pins processing_system7_1_axi_periph/M03_ACLK] [get_bd_pins processing_system7_1_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_1_100M/slowest_sync_clk] [get_bd_pins sws_8bits/s_axi_aclk]
